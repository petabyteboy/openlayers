...
class CanvasImageLayerRenderer extends CanvasLayerRenderer {
    ...
    renderFrame(frameState, target) {
        ...
        const transform = composeTransform(this.tempTransform_, width / 2, height / 2, scale, scale, 0, imagePixelRatio * (imageExtent[0] - viewCenter[0]) / imageResolution, imagePixelRatio * (viewCenter[1] - imageExtent[3]) / imageResolution);
